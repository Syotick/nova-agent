...
[中文 README](../README.md) ｜ [📚 Course Map](./guide/README.md) ｜ [📘 Exercises](./exercises/README.md) ｜ [🎓 Capstone](./exercises/capstone.md) ｜ [📖 Glossary](./glossary.md)
...
├─ docs/                      # teaching docs (course map / exercises / walkthroughs / glossary)
└─ package.json
```
...
**Documentation**: [中文 README](../README.md)
...
- [📚 Course Map（课程地图 · 学习路径）](./guide/README.md) — a three-stage path (入门 → 进阶 → 挑战) across the 8 core files, with per-lesson acceptance criteria
- [📘 Exercises（练习册）](./exercises/README.md) — hands-on drills per lesson (入门/进阶/挑战), with separate answers so you can self-check honestly
- [🎓 Capstone（终极验收项目）](./exercises/capstone.md) — re-implement a minimal agent from scratch to graduate
- [📖 Glossary（术语总表）](./glossary.md) — every term from every walkthrough, in one place
